...
class DataTransfomarion:
    def __init__(self):
        self.data_transformation_config = DataTransformationConfig()

    def get_data_transformer_obj(self):
        """
        This function is for transforming data

        return:
            return preprocess pipeline of standard scaling, one hot coding, and imputer
        """
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)] #add array columnwise
